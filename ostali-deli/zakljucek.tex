...
Glavni rezultat naloge je razvoj odprtokodne spletne aplikacije \textit{RF Site Planner}, ki združuje simulacijo radijske pokritosti, analizo vidne linije ter iskanje optimalnih lokacij oddajnikov v eni sami rešitvi. Aplikacija temelji na preverjenem propagacijskem orodju SPLAT!, nadgrajenem z modernim uporabniškim vmesnikom in skalabilno strežniško arhitekturo. Poseben poudarek je bil namenjen učinkoviti obdelavi prostorskih podatkov, uporabi standardnih GIS storitev ter jasni in interaktivni vizualizaciji rezultatov.
