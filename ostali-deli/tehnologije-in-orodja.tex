...
Pri razvoju diplomske naloge sem se odločil uporabiti sodobna orodja in tehnologije. Poleg tega so izbrane rešitve preverjene, odprtokodne ter široko uporabljane v industriji, kar zagotavlja stabilnost in dolgoročno vzdržnost sistema. V nadaljevanju predstavljam ključne tehnologije in orodja, ki so bila uporabljena pri razvoju aplikacije, ter njihovo vlogo pri delovanju celotne rešitve.

\section{Vue.js}
Vue.js~\cite{vuejs} je odprtokodno ogrodje za gradnjo uporabniških vmesnikov, ki temelji na programskem jeziku JavaScript. Namenjen je za gradnjo enostranskih aplikacij z več manjšimi gradniki, ki jih lahko ponovno uporabimo na več različnih delih aplikacije. S tem prihranimo čas pri programiranju in zmanjšamo število vrstic kode.

Prva verzija je ugledala luč sveta leta 2014. Zasnoval in ustvaril ga je Evan You kot izboljšavo ogrodja AngularJS~\cite{angularjs} potem, ko je z njim delal v podjetju Google.
