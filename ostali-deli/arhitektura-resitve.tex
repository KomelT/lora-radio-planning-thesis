...
\begin{itemize}
    ...
    \item analizo vidne linije (angl.~\emph{line of sight}) med dvema izbranima točkama,
...
Poleg zemljevida čelni sistem vključuje tudi obrazce za vnos parametrov simulacij ter pregledne prikaze rezultatov. Za zagotavljanje konsistentnosti podatkov se uporablja centralizirana shramba stanja, komunikacija z zalednim sistemom pa poteka prek klicev REST API.
