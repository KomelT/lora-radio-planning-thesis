...
\section{Arihtektura aplikacije}
...
\begin{itemize}
    ...
    \item posredniški strežnik Nginx \cite{nginx},
    \item okolje Docker \cite{docker}.
\end{itemize}
...
\paragraph{Redis}
Redis \cite{redis} v arhitekturi deluje kot pomnilniški posrednik med čelnim in zalednim delom aplikacije. V njem se hranijo statusi opravil in končni rezultati simulacij. Zaradi arhitekture ključ--vrednost in delovanja neposredno v pomnilniku omogoča zelo hitro shranjevanje in pridobivanje podatkov, kar bistveno prispeva k odzivnosti sistema.
