...
\section{Razprava}
Rezultati kažejo jasno odvisnost natančnosti simulacij od propagacijskih pogojev. V primerih z vidno linijo je razlika med izmerjenimi in simuliranimi vrednostmi RSSI relativno majhna, mediane napak pa se pri obeh sprejemnikih gibljejo okoli 10~dB. To potrjuje, da uporabljen radijski model v pogojih vidne linije ustrezno opisuje osnovne propagacijske mehanizme. \cite{6618611}

V primerih brez vidne linije (NLOS) so odstopanja okoli 20~dB. Simulacija pogosto podcenjuje dejanski doseg povezave, kar se odraža v negativni mediani napak in veliki razpršenosti podatkov. Posamezna odstopanja presegajo 40~dB.