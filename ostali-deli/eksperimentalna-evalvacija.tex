...
Z eksperimentalno evalvacijo sem želel preverit natačnost razvite aplikacije in osovnega sistema SPLAT!, ki je uporabljena za simuliranje. Evalvacija sistema je bila izvedena na podlagi dejanskih terenskih meritev v realnem okolju. Pri tem sem uporabil obstoječo infrastrukturo omrežja Meshtastic, ki jo imam v upravljanju, kar je omogočilo izvajanje ponovljivih in nadzorovanih meritev v realnih pogojih delovanja sistema.
...
Vsa oprema deluje na ISM frekvenčem območju 868~MHz, z močjo 27~dBm. Lokacijski paketi so bili oddajani na 15~s. Vozil sem z povprečno hitrostjo 50~kmh.
