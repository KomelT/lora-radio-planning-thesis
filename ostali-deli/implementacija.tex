...
Sistemu sem dodal dve novi API poti (angl.~\emph{routes}):
\begin{itemize}
...
Pomembna funkcionalnost, ki sem jo dodal v aplikacijo, je simulacija vidne linije (angl.~\emph{Line-of-Sight}, LOS) med dvema izbranima točkama.
